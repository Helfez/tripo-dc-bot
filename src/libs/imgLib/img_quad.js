...
*/
module.exports.merge_to_grid = function(image_bufs) {
    const ptr0 = passArrayJsValueToWasm0(image_bufs, wasm.__wbindgen_export_2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.merge_to_grid(ptr0, len0);
...
* @returns {Promise<Promise<any>>}
*/
module.exports.resize_to_webp = function(image_buf, width, height) {
    const ret = wasm.resize_to_webp(addHeapObject(image_buf), width, height);
    return takeObject(ret);
};
...
*/
module.exports.ChromaSampling = Object.freeze({
/**
...
module.exports.__wbg_new_132e2fd5dfe036c3 = function(arg0) {
...
module.exports.__wbindgen_closure_wrapper1913 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 138, __wbg_adapter_18);
    return addHeapObject(ret);
};

const path = require('path').join(__dirname, 'img_quad_bg.wasm');
